...
For detailed instructions, see the [Installation and Setup Guide](./Installation_and_Setup.md).
___
...
├── Installation_and_Setup.md    # Installation and setup guide
├── Setup_via_Smartphone.md      # Smartphone setup instructions
├── binaries/                    # Firmware binaries for flashing
├── FlashTool.exe                # Firmware flashing utility
├── CrowPanelConfigurator.exe    # Device configuration tool
├── Firmware.zip                 # Archived firmware package
└── assets/
